...
- **[Footer Rule]** 보고서의 맨 마지막 줄에 반드시 다음 문구를 포함하십시오:
  "※ 본 보고서는 사용자가 제공한 정보 및 검색된 감사 사례를 바탕으로 작성된 초안입니다."
- 오직 교정된 감사 보고서의 본문 마크다운만 출력하십시오.
"""
...
3. **불필요 섹션 제거**: '[Tone and Manner]' 및 '[참고 문서]', '[Data Source]'와 같은 메타 정보 섹션을 절대 출력하지 마십시오. 오직 보고서 제목(# 감사 보고서)부터 내용까지만 출력합니다.
4. **첫 토큰 제한**: 답변의 첫 번째 글자는 반드시 마크다운 제목 기호인 `#`으로 시작해야 합니다.
5. **내용만 출력**: 오직 교정된 감사 보고서의 본문 마크다운만 출력하십시오.
""",
                ),
            ]
        )
